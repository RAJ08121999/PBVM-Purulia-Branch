  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: "2.5rem", width: "100%" }}>
      ...
      <div style={{ flex: 1, minWidth: "300px", width: "100%" }}>
        ...
        <p style={{ color: "var(--color-text-muted)", fontSize: "0.95rem", width: "100%" }}>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(350px, 1fr))", gap: "2rem", width: "100%" }}>
        ...
        {/* Guidelines */}
        <div className="card" style={{ padding: "2rem", background: "#ffffff", display: "flex", flexDirection: "column", justifyContent: "space-between", width: "100%", boxSizing: "border-box" }}>
          <div>
